...
function MetricCard({ icon, label, value, isLoading }: MetricCardProps) {
  return (
    <motion.div
      variants={spaceInUpCardVariants}
      ...
      <div className="w-full max-w-[1504px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center gap-10">
          ...
          <motion.div
            ...
            className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 w-full max-w-4xl [perspective:900px]"
          >
            <MetricCard
